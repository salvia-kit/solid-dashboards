...
export function Content(props: ContentProps) {
  return (
    <div class="flex flex-col flex-wrap sm:flex-row">
          ...
          <div class="flex items-center">
            <span class="relative rounded-xl bg-purple-200 p-4">
              <svg
                ...
                fill="currentColor"
                height="40"
                class="absolute left-1/2 top-1/2 h-4 -translate-x-1/2 -translate-y-1/2 text-purple-500"
            ...
            <p class="ml-2 text-black">{props.title || "Total Gains"}</p>
          </div>
      ...
      <div class="mb-6 w-full pr-2 md:w-4/12">
        <div class="rounded-2xl bg-white p-4 shadow">
          <div class="flex items-center">
            ...
            <p class="text-md ml-2 text-black">Outgoings</p>
          </div>
          <div class="flex flex-col justify-start">
            <p class="my-4 text-left text-4xl font-bold text-gray-700">
              10,000
      ...
      <div class="w-full md:w-4/12">
        <div class="rounded-2xl bg-white p-4 shadow">
          <div class="flex items-center">
            ...
            <p class="text-md text-black md:ml-4">Bonus</p>
          </div>
          <div class="flex flex-col justify-start">
            <p class="my-4 text-left text-4xl font-bold text-gray-700">
              3500
      ...
      <div class="relative mt-8 w-full overflow-hidden rounded-xl bg-white p-4 shadow-lg md:mr-2 md:w-3/12">
        <p class="mb-6 text-xl font-light text-gray-600">Popular Investors</p>
        <div class="grid grid-cols-3 gap-4">
          <div class="flex flex-col items-center">
            ...
            <span class="mt-2 text-xs text-gray-600">Enoch Ndika</span>
          </div>
          <div class="flex flex-col items-center">
            <div class="relative">
              <a href="#" class="relative block">
            ...
            <span class="mt-2 text-xs text-gray-600">Lionel Messi</span>
          </div>
          <div class="flex flex-col items-center">
            <div class="relative">
              <a href="#" class="relative block">
            ...
            <span class="mt-2 text-xs text-gray-600">Jonathan Ilunga</span>
          </div>
          <div class="flex flex-col items-center">
            <div class="relative">
              <a href="#" class="relative block">
            ...
            <span class="mt-2 text-xs text-gray-600">Maurice Lokumba</span>
          </div>
          <div class="flex flex-col items-center">
            <div class="relative">
              <a href="#" class="relative block">
            ...
            <span class="mt-2 text-xs text-gray-600">Cristiano Ronaldo</span>
          </div>
          <div class="flex flex-col items-center">
            <div class="relative">
              <a href="#" class="relative block">
            ...
            <span class="mt-2 text-xs text-gray-600">Dave Glad</span>
          </div>
        </div>
      </div>
      <div class="relative mt-8 w-full overflow-hidden rounded-xl bg-white p-4 text-gray-700 shadow-lg md:ml-2 md:w-4/12">
        <a href="#" class="block h-full w-full">
          <div class="w-full">
            <p class="mb-4 text-2xl font-light text-gray-700">Task Progress</p>
            ...
            <div class="mb-4 h-2 w-full rounded-full bg-indigo-100">
              <div class="h-full w-2/3 rounded-full bg-indigo-400 text-center text-xs text-white" />
            </div>
            <div class="flex items-center justify-between text-sm text-gray-400">
              <p>DevOps</p>
              <p>2/8</p>
            ...
            <div class="mb-4 h-2 w-full rounded-full bg-blue-100">
              <div class="h-full w-1/4 rounded-full bg-blue-400 text-center text-xs text-white" />
            </div>
            <div class="flex items-center justify-between text-sm text-gray-400">
              <p>Marketing</p>
              <p>8/8</p>
      ...
      <div class="relative mt-8 w-full overflow-hidden rounded-xl bg-white p-4 shadow-lg md:ml-4 md:w-4/12">
        <div class="mb-8 flex w-full items-center justify-between">
          <p class="text-xl text-gray-800">Account</p>
          <a
            href="#"
            class="flex items-center border-0 text-sm text-gray-300 hover:text-gray-600 focus:outline-none"
          >
            VIEW ALL
          </a>
        </div>
        <div class="mb-6 flex items-center justify-between rounded">
          ...
          <div class="flex w-full items-center justify-between">
            <div class="ml-2 flex w-full flex-col items-start justify-between text-sm">
