      ...
      <div class="w-full sm:w-1/2 xl:w-1/3">
        <div class="mb-4">
          <div class="w-full rounded-2xl bg-white p-4 shadow-lg">
            ...
            <div class="mb-4 flex items-center justify-between space-x-12">
              <span class="flex items-center rounded-md bg-gray-200 px-2 py-1 text-xs font-semibold text-gray-500">
                PROGRESS
              </span>
              <span class="flex items-center rounded-md border border-red-400 bg-white px-2 py-1 text-xs font-semibold  text-red-400">
                HIGH PRIORITY
              </span>
            </div>
            <div class="m-auto block">
              ...
              <div class="mt-2 h-2 w-full rounded-full bg-gray-200">
                <div class="h-full w-1/2 rounded-full bg-purple-500 text-center text-xs text-white" />
              </div>
            </div>
            <div class="my-4 flex items-center justify-start space-x-4">
              <span class="flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-semibold text-green-500">
                IOS APP
              </span>
              <span class="flex items-center rounded-md bg-blue-100 px-2 py-1 text-xs font-semibold text-blue-500">
                UI/UX
              </span>
            </div>
            ...
            <span class="mt-4 flex w-36 items-center rounded-md bg-yellow-100 px-2 py-1 text-xs font-semibold text-yellow-500">
              DUE DATE : 18 JUN
            </span>
          </div>
        </div>
        <div class="mb-4">
          <div class="w-full rounded-2xl bg-white p-4 shadow-lg">
            ...
            <div class="mb-4 flex items-center justify-between space-x-12">
              <span class="flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-semibold text-green-700">
                COMPLETED
              </span>
              <span class="flex items-center rounded-md border border-green-600 bg-white px-2 py-1 text-xs font-semibold text-green-600">
                MEDIUM PRIORITY
              </span>
            </div>
            <div class="m-auto block">
              ...
              <div class="mt-2 h-2 w-full rounded-full bg-gray-200">
                <div class="h-full w-full rounded-full bg-pink-400 text-center text-xs text-white" />
              </div>
            </div>
            <div class="my-4 flex items-center justify-start space-x-4">
              <span class="flex items-center rounded-md bg-green-50 px-2 py-1 text-xs font-semibold text-green-500">
              ...
              <span class="flex items-center rounded-md bg-yellow-200 px-2 py-1 text-xs font-semibold text-yellow-600">
                ANDROID
              </span>
            </div>
            <div class="flex -space-x-2">
      ...
      <div class="w-full sm:w-1/2 xl:w-1/3">
        <div class="mx-0 mb-4 sm:ml-4 xl:mr-4">
          <div class="w-full rounded-2xl bg-white shadow-lg">
            ...
            <ul>
              <li class="flex items-center justify-between border-b-2 border-gray-100 py-3 text-gray-600">
              ...
              <li class="flex items-center justify-between border-b-2 border-gray-100 py-3 text-gray-400">
                <div class="flex items-center justify-start text-sm">
        ...
        <div class="mb-4 sm:ml-4 xl:mr-4">
          <div class="w-full rounded-2xl bg-white shadow-lg">
            <div class="flex items-center justify-between p-4">
              ...
              <button class="mr-4 rounded border border-gray-400 p-1 text-sm text-gray-400">
                <svg
                  width="15"
                  height="15"
                  fill="currentColor"
            ...
            <div class="flex items-center justify-between border-l-4 border-blue-500 bg-blue-100 px-4 py-2 text-gray-600">
              ...
              <div class="flex items-center">
                ...
                <button class="mr-4 rounded border bg-blue-500 p-1 text-sm text-gray-400">
                  <svg
                    width="17"
                    height="17"
                    fill="currentColor"
            ...
            <div class="flex items-center justify-between border-b-2 border-gray-100 p-4">
            ...
            <div class="flex items-center justify-between border-b-2 border-gray-100 px-4 py-2 text-gray-600">
              <p class="flex items-center text-xs">
                <svg
                  width="20"
                  height="20"
