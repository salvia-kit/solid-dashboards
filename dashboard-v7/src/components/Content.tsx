  ...
  return (
    <div>
        ...
        <div class="py-8">
          ...
          <div class="py-4">
            <div class="max-w-full overflow-x-auto rounded-lg shadow">
              ...
              <div class="xs:flex-row xs:justify-between flex flex-col items-center bg-white p-5">
                <div class="flex items-center">
                  <button
                    type="button"
      ...
      <div class="flex-wrap items-center justify-center gap-8 text-center sm:flex">
        <div class="mt-6 w-full rounded-lg bg-white p-4 shadow-lg sm:w-1/2  md:w-1/2 lg:w-1/4">
          <div class="shrink-0">
            <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-gray-600 text-white">
              <svg
                width="20"
                height="20"
                fill="currentColor"
        ...
        <div class="mt-6 w-full rounded-lg bg-white p-4 shadow-lg sm:mt-16 sm:w-1/2 md:mt-20 md:w-1/2 lg:mt-24 lg:w-1/4">
          <div class="shrink-0">
            <div class="mx-auto flex h-12 w-12 items-center justify-center rounded-md bg-gray-600 text-white">
              <svg
                width="20"
