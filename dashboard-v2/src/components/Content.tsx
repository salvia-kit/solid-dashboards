...
export function Content(props: ContentProps) {
  return (
    <div>
      ...
      >
        <div>
          <h3 class="m-0 flex items-center text-lg font-medium">
            <svg viewBox="0 0 512 512" class="mr-3 w-12 lg:w-8">
              <path
          ...
          <button class="rounded-2xl bg-blue-700 px-4 py-2 text-white">
            Start free trial
          </button>
        </div>
        <img
      ...
      <div class="mb-3 mt-6 text-gray-400">Installed</div>
      <div
      ...
      >
        <div class="mb-6 flex justify-end border-b border-gray-600 pb-2">
          ...
          <div class="mx-auto flex">
            <span class="relative text-base">
              <span class="absolute left--2 top-1 h-2 w-2 rounded-full bg-green-400" />
              <span class="pl-4">Updated</span>
            </span>
          </div>
          <div class="ml-auto flex">
            <div>
              <button class="rounded-full border border-gray-500 px-5 py-1 text-gray-500">
                Open
              </button>
            </div>
          </div>
        ...
        <div class="mb-6 flex justify-end border-b border-gray-600 pb-2">
          ...
          <div class="mx-auto flex">
            <span class="relative text-base">
              <span class="absolute left--2 top-1 h-2 w-2 rounded-full bg-indigo-400" />
              <span class="pl-4">Updated</span>
            </span>
          </div>
          <div class="ml-auto flex">
