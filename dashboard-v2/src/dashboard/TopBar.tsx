        ...
        <div class="relative flex w-full items-center pl-1 sm:ml-0 sm:pr-2 ">
          <div class="container relative left-0 flex h-auto  w-3/4">
            ...
            <div class="group relative hidden h-full w-full items-center md:flex lg:w-64">
              <div class="absolute flex h-10 w-auto cursor-pointer items-center justify-center p-3 pr-2 text-sm uppercase text-gray-500 sm:hidden">
                <svg
                  fill="none"
              ...
              <svg
                fill="black"
                class="pointer-events-none absolute left-0 ml-4 hidden h-4 w-4  group-hover:text-gray-400 sm:block"
              ...
              <input
                ...
                placeholder="Search"
              />
              <div class="absolute right-0 mr-2 hidden h-auto rounded-2xl border border-gray-300 px-2 py-1 text-xs text-gray-400 md:block">
                +
              </div>
            </div>
          </div>
          <div class="relative ml-5 flex w-9/12 items-center justify-end p-1 sm:right-auto sm:mr-0 md:w-1/4">
            ...
            <a href="#" class="relative block rounded px-3 py-2 text-gray-700">
              <span>
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-6 w-6"
              ...
              <span class="absolute right-0 top-0 rounded-full bg-blue-700 px-2 py-0.5 text-xs font-bold text-white">
                3
              </span>
            </a>
